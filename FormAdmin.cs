...
namespace ReservasiFutsal02
{
    ...
    public partial class FormAdmin : Form // Form utama untuk role Admin, berisi sidebar navigasi dan panel konten untuk sub-form manajemen
    {
        ...
        private void btnNavJadwal_Click(object sender, EventArgs e) // event handler untuk tombol navigasi Jadwal, membuka form Jadwal dan mengatur tombol sebagai aktif
        {
        ...
        // ── Logout ────────────────────────────────────────────────
        private void btnLogout_Click(object sender, EventArgs e) // event handler untuk tombol Logout, menampilkan konfirmasi dan kembali ke dashboard jika user memilih Yes
        {
